<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="GroupUpdateQueryResult.aspx.cs" Inherits="GroupUpdate_GroupUpdateQueryResult" %>
 ...
 <br />
					<div style="text-align: center;">
						&nbsp;<asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click" 
                            Text="Search Again" />
                        &nbsp;<asp:Button ID="btnBack" runat="server" Text="Back to Group Updates" 
