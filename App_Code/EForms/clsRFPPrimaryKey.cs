 ...
 public class clsRFPPrimaryKey
 {
  ...
  public void Fill()
  {
   using (SqlConnection cn = new SqlConnection(clsSpeedo.SpeedoConnectionString))
   {
    ...
    cmd.CommandText = "SELECT xkey, xvalue FROM Finance.RFPPrimaryKey WHERE xkey=@xkey";
  ...
  public static string GetValue(string pXkey)
  {
   ...
   {
    SqlCommand cmd = cn.CreateCommand();
    cmd.CommandText = "SELECT xvalue FROM Finance.RFPPrimaryKey WHERE xkey=@xkey";
