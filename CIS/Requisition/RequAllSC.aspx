<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="RequAllSC.aspx.cs" Inherits="CIS_Requisition_RequAllSC" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="RequAllSC.aspx?mode=a&page=1" class="SiteMap">View All Requisition</a>
    </div>        
   </td>
  </tr>
      ...
      <%-- <tr>
       ...
       <tr>
        ...
        <td class="GridRows" style="width:75%;">
         ...
         <asp:RadioButton runat="server" ID="radModeForApproval" GroupName="RequestMode" Text="For Processing" AutoPostBack="true" />        
        </td>
       </tr>
      </table>
     </div>
