<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="MRCFDetailsGH.aspx.cs" Inherits="CIS_MRCF_MRCFDetailsGH" %>
    ...
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="3" class="grid">      
       ...
       <tr>
        ...
        <td class="GridRows">
         <asp:TextBox runat="server" ID="txtChargeTo" CssClass="controls" Width="80%" ReadOnly="true"></asp:TextBox>
       ...
       <tr>
        ...
        <td class="GridRows"><asp:TextBox runat="server" ID="txtIntended" 
                CssClass="controls" Width="470px" BackColor="white" Enabled="False"></asp:TextBox></td>
       </tr>       
       <tr> 
       ...
       <tr>
        ...
        <td class="GridRows"><asp:TextBox runat="server" ID="txtGrpHeadRem" CssClass="controls" Width="98%" TextMode="MultiLine" Rows="3" MaxLength="200" BackColor="white"></asp:TextBox></td>
       </tr>
       <tr>
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="0" class="grid" cellspacing="0">
       <tr>
        <td colspan="2" class="GridText" style="width: 611px">
         <table cellspacing="0" width="100%">
          <tr>
           ...
           <td style="text-align:right; vertical-align:middle;">
            <asp:CheckBox runat="server" ID="chkShowSpecification" Checked="true" AutoPostBack="true" Text="Show Specification" Font-Size="Small" OnCheckedChanged="chkShowSpecification_CheckedChanged" />&nbsp;</td>
          </tr>
         </table>         
        </td>
       </tr>
       <tr>
        <td class="GridRows" style="width: 611px">
         <div class="GridBorder" >
	             ...
	             <table cellpadding="1" width="100%">
	              <tr><td>
                      <asp:TextBox runat="server" ID="txtItemDesc"  
                          ...
                          BackColor="white" Width="100%" Enabled="False" ReadOnly="True"></asp:TextBox></td></tr>
	              <tr><td style="display: none"><asp:Label runat="server" ID="lblAsset" Text='<%#DataBinder.Eval(Container.DataItem, "asstcode")%>'></asp:Label></td></tr>	          
	              <tr><td><asp:TextBox runat="server" ID="txtItemSpec" 
                          Text='<%#DataBinder.Eval(Container.DataItem, "itemspec")%>' CssClass="controls" 
                          BackColor="white" TextMode="MultiLine" Width="100%" Rows="5" 
...
<ItemStyle HorizontalAlign="Left" CssClass="GridRows"></ItemStyle>
           ...
           <table cellpadding="0" width="100%">
	              <tr><td>   
           <asp:TextBox runat="server" ID="txtQty" Enabled="false" CssClass="controls" 
            ...
            <asp:TemplateColumn HeaderText="Date Needed" HeaderStyle-Width="20%">
             ...
             <ItemTemplate>
              ...
              <cc1:GMDatePicker ID="dteDateNeeded" Enabled="false" runat="server" 
                     CssClass="controls" DisplayMode="Label" Font-Size="X-Small" 
                     CalendarTheme="Blue" BackColor="white" 
