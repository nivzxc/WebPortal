<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="TranAllGH.aspx.cs" Inherits="CIS_Transmittal_TranAllGH" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="TranAllGH.aspx?mode=a&page=1" class="SiteMap">View All Transmittal</a>
    </div>        
   </td>
  </tr>--%>
