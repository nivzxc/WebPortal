<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="LeaveDetailsReport.aspx.cs" Inherits="Report_Default" %>
...
<%--  <tr><td style="height:9px;"></td></tr>--%>
        ...
        <tr>
            <td>
                <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
                    <b><span class="HeaderText">Leave Details</span></b>
                    <br />
                    <br />
         ...
         Date To:
                            ...
                            <tr>
                                <td class="GridRows" style="vertical-align:top;">
                                    Reason:</td>
                                <td class="GridRows">
                                    <asp:TextBox runat="server" ID="txtReason" CssClass="controls" Width="85%" MaxLength="255" ReadOnly="true" TextMode="MultiLine" Rows="3" ValidationGroup="save"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="GridRows">
                            ...
                            <tr>
                                <td class="GridRows">
                                    Date Approved:</td>
                                <td class="GridRows">
                                    <asp:TextBox runat="server" ID="txtApproverDate" CssClass="controls" Width="200px" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="GridRows" style="vertical-align:top;">
                                    Remarks:</td>
                                <td class="GridRows">
                                    <asp:TextBox runat="server" ID="txtApproverRemarks" CssClass="controls" Width="85%" ReadOnly="true" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
