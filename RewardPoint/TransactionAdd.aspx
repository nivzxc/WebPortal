<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="TransactionAdd.aspx.cs" Inherits="RewardPoint_TransactionAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
 ...
 <%-- <tr>
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     <b><span class="HeaderText">Create New Reward Transaction</span></b> 
     <br />
 ...
 <br />
        ...
        <td>                 
         <div class="GridBorder">          
          <table width="100%" cellpadding="2" class="grid">  
           <tr>
            <td class="GridColumns" style="width:45%"><b>Employee Name</b></td>
            <td class="GridColumns" style="width:20%"><b>Points</b></td>
            <td class="GridColumns" style="width:10%"><b>Type</b></td>
            <td class="GridColumns" style="width:25%"><b>Date Acquired</b></td>
           </tr>         
           <tr>           
            <td class="GridRows">
            ...
            <td class="GridRows" style="text-align:center;">
                <asp:TextBox ID="txtPoints" runat="server" BackColor="white" 
                    ...
                    ErrorMessage="<b>Invalid Entry</b><br>Numeric values are only allowed." 
     ...
     <div style="text-align:center;width:100%">
      <%--<asp:ImageButton runat="server" ID="btnSave" ImageUrl="~/Support/btnSend.jpg" 
             ValidationGroup="Save" OnClick="btnSave_Click"/>--%><asp:Button ID="btnSave" runat="server"
                 Text="Save" ValidationGroup="Save" OnClick="btnSave_Click"/>&nbsp;<%--<asp:ImageButton 
             runat="server" ID="btnBack" ImageUrl="~/Support/btnBack.jpg" 
             onclick="btnBack_Click"/>--%><asp:Button ID="btnBack" runat="server"
