<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OCA.aspx.cs" Inherits="Survey_OCA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
 <head id="Head1" runat="server">
  <title>HROD Survey - Organizational Climate Assessment</title>
          ...
          <td>
           <table>            
            <tr>
             ...
             <td><b><span class="HeaderText">Organizational Climate Assessment</span></b></td>
            </tr>
           </table>           
          </td>
         </tr>
         ...
         <tr>
          <td>
           <table width="100%">
            ...
            <tr>
             <td>
              <span style="color:#4682b4;font-size:small;">
               Dear STI Employee,
               <br /><br />
               Thank You for taking part in this Survey. Your opinion matters and your contributions are highly valued . Your opinion will be utilized to highlight improvement opportunities for our organization.
               <br /><br />
               Consider the department you work in as well as your organization as a whole when completing this assessment.
               <br /><br />
               Please be as candid and honest as you answer the questions. Your answers are treated with utmost confidentiality, and used for improvement purposes only. 
               <br /><br />
               Rate each of the areas below on a scale form 1 (lowest or least) to 5 (highest or most). The survey has 56 questions in 7 categories. 
               <br /><br />
                 ...
                 <td>
                  <div class="GridBorder">
                   <asp:DataGrid runat="server" ID="dgSurveyCategory" AutoGenerateColumns="false" Width="100%" BorderStyle="Solid">
                    ...
                    <Columns>
                     <asp:TemplateColumn HeaderText="Organizational Climate Assessment" HeaderStyle-Height="25" HeaderStyle-VerticalAlign="Middle" HeaderStyle-CssClass="DataGridColumns">
                      <ItemTemplate>
                       <table width="100%">
                        <tr>
                         <td>
            ...
            <tr><td style="text-align:center;"><asp:ImageButton runat="server" ID="btnSave" ImageUrl="~/Support/btnSaveForm.jpg" OnClick="btnSave_Click" /></td></tr>                      
           </table>
          </td>
         </tr>
        </table>
