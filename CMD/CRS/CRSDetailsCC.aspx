<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="CRSDetailsCC.aspx.cs" Inherits="CMD_CRS_CRSDetailsCC" %>

<asp:Content ID="cntCRSDetailsCC" ContentPlaceHolderID="cphBody" Runat="Server" Visible="true">
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="CRSDetailsCC.aspx?crscode=<%Response.Write(Request.QueryString["crscode"]); %>" class="SiteMap">Courseware Request Details</a>
    </div>        
   </td>
  </tr>
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="3" class="grid">      
       ...
       <tr>
        ...
        <td class="GridRows"><asp:TextBox runat="server" ID="txtSchlName" CssClass="controls" Width="250px" ReadOnly="true"></asp:TextBox></td>
       </tr>       
       <tr>
        <td class="GridRows" style="vertical-align:top;">Remarks:</td>
        <td class="GridRows"><asp:TextBox runat="server" ID="txtRemarks" CssClass="controls" Width="98%" ReadOnly="true" TextMode="MultiLine" Rows="3"></asp:TextBox></td>
       </tr>
       <tr>
       ...
       <tr>
        <td class="GridRows" style="vertical-align:top;">Remarks:</td>
        <td class="GridRows"><asp:TextBox runat="server" ID="txtCMHRem" CssClass="controls" Width="98%" TextMode="MultiLine" Rows="3" ReadOnly="true"></asp:TextBox></td>
       </tr>       
       <tr>
       ...
       <tr>
        <td class="GridRows" style="vertical-align:top;">Remarks:</td>
        <td class="GridRows"><asp:TextBox runat="server" ID="txtCCRem" CssClass="controls" Width="98%" TextMode="MultiLine" Rows="3" BackColor="white"></asp:TextBox></td>
       </tr>       
       <tr>
     ...
     <table>
      <tr>
       <td><img src="../../Support/bookcase32.png" alt="School" /></td>
     ...
     <div style="text-align:center;" id="divButton" runat="server">
      <asp:ImageButton runat="server" ID="btnSaveChanges" ImageUrl="~/Support/btnSaveChanges.jpg" OnClick="btnSaveChanges_Click" />
     </div>
    </div>      
   </td>
  </tr>
