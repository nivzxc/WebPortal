<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="CRSDetailsEU.aspx.cs" Inherits="CMD_CRS_CRSDetailsEU" %>
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="CRSDetailsEU.aspx?crscode=<%Response.Write(Request.QueryString["crscode"]); %>" class="SiteMap">Courseware Request Details</a>
    </div>        
   </td>
  </tr>
