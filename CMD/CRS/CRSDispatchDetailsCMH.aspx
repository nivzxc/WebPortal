<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CRSDispatchDetailsCMH.aspx.cs" Inherits="CMD_CRS_CRSDispatchDetailsCMH" %>
    ...
    <div class="GridBorder">
     <table width="100%" cellpadding="5" class="grid">
      ...
      <tr>
       ...
       <td class="GridColumns" style="width:70%"><b>Receiving Details</b></td>
      </tr>
      <% LoadDispatch(); %>
     </table>
    </div>
