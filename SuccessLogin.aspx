    ...
    <tr>
     <td>
      <span style="font-size:small;font-family:Verdana;">
       ...
       <br />
       <br />
       You are now logged in as: <% =Request.Cookies["Speedo"]["UserName"]%>
       <br />
       <br />
       Please wait while we transfer you... 
       <br />
       <br />
       <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/default.aspx" Text="(Or click here if you do not wish to wait)"></asp:HyperLink>
      </span>
     </td>
    </tr>
   </table>
