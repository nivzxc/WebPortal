<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="AccountItemsMaintenanceModify.aspx.cs" Inherits="BudgetManagement_AccountItemsMaintenanceModify" %>
...
<%--  <tr><td style="height:9px;"></td></tr>--%>
   ...
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     <b><span class="HeaderText">Edit/ Disable Account Item</span></b>
     <br />
     <br />
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="3" class="grid"> 
       ...
       <tr>
        <td class="GridRows" style="width:30%; height: 20px;" >Account Item Code:</td>
        <td class="GridRows" style="height: 20px; width:70%;">
            <asp:Label ID="lblAccountItemCode" runat="server"></asp:Label>
           </td>
       </tr>       
       <tr id="trDivision" runat="server">
        <td class="GridRows">Account Item Name:</td>
        <td class="GridRows">
            <asp:TextBox ID="txtAccountItemName" runat="server" Width="229px"></asp:TextBox>
           </td>
       </tr>
       <tr id="trDepartment"  runat="server">
        ...
        <td class="GridRows">Oracle Code:</td>
        <td class="GridRows">
            <asp:TextBox ID="txtOracleCode" runat="server" Width="229px"></asp:TextBox>
           </td>
       </tr>
