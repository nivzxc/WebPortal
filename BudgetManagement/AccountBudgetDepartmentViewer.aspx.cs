...
public partial class BudgetManagement_AccountBudgetDepartmentViewer : System.Web.UI.Page
{
    ...
    {
        lblResponsibilityCode.Text = clsRC.GetRCName(clsEmployee.GetRCCode(Request.Cookies["Speedo"]["UserName"].ToString()));
    }
