<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="AccountBudgetAdjustment.aspx.cs" Inherits="BudgetManagement_AccountBudgetAdjustment" %>
...
<%--  <tr><td style="height:9px;"></td></tr>--%>
   ...
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     <b><span class="HeaderText">Update Rc&#39;s Budget</span></b>
     <br />
     <br />
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="3" class="grid"> 
       ...
       <tr>
        <td class="GridRows" style="width:30%; height: 20px;">Budget Category:</td>
        <td class="GridRows" style="height: 20px; width:70%;">
            <asp:DropDownList ID="ddlBudgetCategory" runat="server">
            </asp:DropDownList>
           </td>
       </tr>
       <tr>
  ...
  <tr><td style="height:9px;"></td></tr>
   ...
   <td>    
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">     
     <b><span class="HeaderText">Available Budget Monitoring - 
                            ...
                            <td class="GridRows">
                             <table width="100%" cellpadding="5" cellspacing="1">
                               <tr>
                                 ...
                                 <td class="masterpanel" style="width:20%;"><b>Budget Category</b></td>
                                 <td class="masterpanel" style="width:40%;"><b>Remarks</b></td>
