<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="PettyCashRequestCashierMenuAll.aspx.cs" Inherits="Finance_PCASH_PettyCashRequestCashierMenuAll" %>
     ...
     <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;" id ="divFinance">    
      ...
      <div class="GridBorder">
       <table width="100%" cellpadding="5" cellspacing="1">
        ...
        <tr><td colspan="3" class="BrowseAll"><a href="../RFP/RFPMenuAll.aspx" 
                style="font-size:small;"></a></td></tr>
       </table>
      </div>         
     </div><br />
    ...
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;" id ="div2">    
      ...
      <div class="GridBorder">
       <table width="100%" cellpadding="5" class="Grid">
        ...
        <% LoadMenuPCASReady(); %>
        <tr><td colspan="2" class="BrowseAll">&nbsp;</td></tr>
       </table>
      </div>         
     </div>
