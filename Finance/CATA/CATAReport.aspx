<%@ Page Language="C#" MasterPageFile="~/App_Master/NoRightPanel.master" AutoEventWireup="true" CodeFile="CATAReport.aspx.cs" Inherits="Finance_CATA_CATAReport" Title="The Official STI Head Office Website" %>
...
<%--  <tr id="none">
  ...
  <tr>
   <td>   
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">     
     ...
     <b><span id="div1" class="HeaderText">Print Request for Cash Advance For Travel Allowance</span></b>
     <br />
     <br />
  ...
  HasPageNavigationButtons="False" />
       <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="../../Support/Report/CataReport.rpt">
        </Report>
