<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="FinanceNewCataRequestExec.aspx.cs" Inherits="Finance_CATA_FinanceNewCataRequestExec" %>
      ...
      <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">   
       ...
       <tr>
        ...
        <td class="GridRows" style="width:75%;">
         <asp:DropDownList ID="ddlExecutive" runat="server" CssClass="controls" 
          Width="40%" BackColor="White" AutoPostBack="True" 
          onselectedindexchanged="ddlExecutive_SelectedIndexChanged"></asp:DropDownList>
            <asp:HiddenField ID="hdnUsername" runat="server" />

                    <asp:CheckBox ID="chkbExecutive"  runat="server" Text="For Executive"  
                oncheckedchanged="chkbExecutive_CheckedChanged"  CssClass="checkB" 
                AutoPostBack="True" Width="40%" Checked="True" />
        </td>
        ...
        <td class="GridRows">
                    <asp:TextBox runat="server" ID="txtPurpose" 
                     CssClass="controls" Width="80%" MaxLength="80" BackColor="white" 
                     ValidationGroup="save"></asp:TextBox>
                    <asp:RequiredFieldValidator runat="server" ID="vldAL4" 
                     ControlToValidate="txtPurpose" ErrorMessage="&lt;br&gt;[Trip Purpose Required]" 
       ...
       <tr>
        ...
        <td class="GridRows">
                    <asp:DropDownList ID="ddlSchool" runat="server" CssClass="controls" Width="50%" 
                     BackColor="White" AutoPostBack="True"></asp:DropDownList>
                             </td>
       </tr>
       <tr>
                                    ...
                                    <tr runat="server" id="trAirFixTransportation" visible="false">
                                      ...
                                      <tr runat="server" id="trAirTerminalFee" visible="false">
                                           ...
                                           <td class="GridRows"><asp:HiddenField ID="hdnAirTerminalFee" runat="server" />
                                            <asp:TextBox runat="server" ID="txtAirTerminalFee"  CssClass="controls" 
                                             Width="25%" BackColor="white" ValidationGroup="save" MaxLength="10" 
                                             AutoPostBack="True" ontextchanged="txtAirTerminalFee_TextChanged" 
                                             ReadOnly="True" ></asp:TextBox>
                                      <asp:RegularExpressionValidator id="re9" runat="server" 
                                             ControlToValidate="txtAirTerminalFee" ErrorMessage="<br>[Invalid Input]" 
                                             ValidationExpression="^\d*([.]\d*)?|[.]\d+$" Display="Dynamic" 
                                             ValidationGroup="SaveRecord" SetFocusOnError="true" ForeColor="Red"></asp:RegularExpressionValidator>
                                             ...
                                             <asp:Panel ID="pnlModal2Header" runat="server" CssClass="modalPopup2Header" >
                                                        <div align="center">
                                                            <table width="100%" >
                                                                <tr>
                                                                <td align="left" style="color: #FFFFFF" height="25px" colspan="2">&nbsp;&nbsp;<b>Terminals</b></td>
<%--                                                                <td align="right">&nbsp;</td>--%>
                                                                </tr>
                                                            </table>
                                                               </div>
                                    ...
                                    <div runat="server" id="divIncedental" visible="false" class="GridBorder"> 
                                            <table width="100%" cellpadding="3" cellspacing="2">
                                               ...
                                               <tr runat="server" id="trIncidentalTotal" visible="false">
                                                  <td class="GridRows" style="width:30%;"><b>&nbsp;Total Incidental  Allowance:</b></td>
                                               ...
                                               <tr>
                                                  ...
                                                  <tr>
                                                         <td class="GridRows" style="width:20%;">&nbsp;Incidental:</td>
                                                         <td class="GridRows"  style="width:80%;"><asp:TextBox runat="server" 
                                          ...
                                          ValidationGroup="AddIncidental" SetFocusOnError="true" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                                   ...
                                                   <tr>
                                                        <td style="width:100%" colspan="2" class="GridRows"><div style="text-align:center" align="center">
                                 ...
                                 <div runat="server" id="divRepresentation" visible="false" class="GridBorder" > 
                                       <table width="100%" cellpadding="3" cellspacing="1">
                                                               ...
                                                               <tr runat="server" id="trRepresentation" visible="false">
                                                                   <td class="GridRows" style="width:30%;"><b>&nbsp;Total 
                                                      ...
                                                      <tr>
                                                       <td class="GridRows" colspan="2" align="center"><asp:Button ID="btnAddPerson" runat="server" Text="Add Person" onclick="btnAddPerson_Click" ValidationGroup="AddRepresentation" /><%--<asp:ImageButton runat="server" ID="btnAddPerson" ImageUrl="~/Support/btnAddItem.jpg" onclick="btnAddPerson_Click" ValidationGroup="AddRepresentation" />--%></td>
                                                       </tr> 
                                         </table>
                                 </div>
                            </td>
                                     ...
                                     <td style="width:400px" align="center">
                                      <div class="GridBorder">
                                       <table width="100%" cellpadding="3">
                                        <tr><td class="GridColumns" colspan="1" style="text-align:center;">
                                         <b>Total Cash Advance for Travel Allowance<asp:Button ID="btnAddTravelAllowance" runat="server" CssClass="controls" 
                     Height="16px" onclick="btnAddTravelAllowance_Click" Text="+" Visible="False" />
                                         </b></td></tr>
                                        <tr>
                                         <td class="GridRows" align="center" style="height: 30px"><b>
                                          <asp:TextBox ID="TextBox1" runat="server" BorderStyle="None" 
                                           CssClass="controls" ReadOnly="True" Width="20px" Font-Bold="True" 
                                           Font-Size="Larger">P</asp:TextBox>
                                          <asp:TextBox runat="server" ID="txtTotalCATAAmount" CssClass="controls"  
                                           Width="45%" MaxLength="10" ValidationGroup="save" ReadOnly="True" 
                                           BorderStyle="None" Font-Bold="True" Font-Size="Larger" ForeColor="#FF3300"></asp:TextBox></b></td>
                                        </tr>
                                       </table>
                                      </div>
                                     </td>
                            ...
                            <td>
                               ...
                               <div runat="server" id="divApprovers" visible="false" class="GridBorder"> 
                                 <table width="100%" cellpadding="3" cellspacing="1">
                                   ...
                                   <tr>
                                        <td class="GridRows" style="width:25%; height: 24px;">&nbsp;Requested By:</td>
                                        <td class="GridRows"  style=" height: 24px;">
                                         <asp:TextBox runat="server" ID="txtRequestorName" CssClass="controls" 
                                          Width="50%" ReadOnly="true" BorderStyle="None"></asp:TextBox>
                                        </td>
                                   </tr>
                                   <tr>
                                        <td class="GridRows" style="width:25%; height: 24px;">&nbsp;Endorsed By:</td>
                                        <td class="GridRows"  style=" height: 24px;">
                                         <asp:DropDownList ID="ddlEndorsedBy1" runat="server" CssClass="controls" 
                                          onselectedindexchanged="ddlEndorsedBy1_SelectedIndexChanged">
                                         </asp:DropDownList>
                                        </td>
                                   </tr>
                                   ...
                                   <tr id="Tr1" runat="server">
                                        <td class="GridRows" style="width:25%; ">&nbsp;Authorized By:</td>
                                        <td class="GridRows"><%--<asp:HiddenField ID="hdnAuthorizedby1" runat="server" />
                                         <asp:TextBox runat="server" ID="txtAuthorizeBy1" CssClass="controls" 
                                          ReadOnly="true" BorderStyle="None" Width="50%"></asp:TextBox>&nbsp;--%><asp:DropDownList ID="ddlDivisionHead" runat="server" CssClass="controls" OnSelectedIndexChanged="ddlAuthorizeby2_SelectedIndexChanged">
                                                        </asp:DropDownList></td>
                                   </tr>
                                    <tr id="trAuthorize2" runat="server" visible="true">
                                        ...
                                        <td class="GridRows">
                                         <asp:DropDownList ID="ddlAuthorizeby2" runat="server" CssClass="controls" 
                                          onselectedindexchanged="ddlAuthorizeby2_SelectedIndexChanged">
                                         </asp:DropDownList>
                                        </td>
                                   </tr>
                                  </table>
