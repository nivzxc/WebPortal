<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="RFPNewRequest.aspx.cs" Inherits="Finance_RFP_RFPNewRequest" Title="The Official STI Head Office Website" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="RFPMenu.aspx" class="SiteMap">Request</a> » 
  ...
  <tr>
   <td>    
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">     
     <b><span class="HeaderText">Create New Request for Payment</span></b>
     <br />
     <br />
...
--%>       <tr>
        <td class="GridRows" style="width:25%;">Payee Type:</td>
        <td class="GridRows" style="width:75%;">
         <asp:DropDownList runat="server" ID="ddlPayee" CssClass="controls"  BackColor="white" onselectedindexchanged="ddlPayee_SelectedIndexChanged"  AutoPostBack="True">
       ...
       <tr runat="server" id="trPayeeRequestor" visible="true">
        <td class="GridRows" >Payee Name:</td>
        <td class="GridRows"><asp:TextBox runat="server" ID="txtRequestor" CssClass="controls" Width="40%" ValidationGroup="save" MaxLength="80" BorderStyle="None" ReadOnly="True" ></asp:TextBox></td>
       </tr>
       <tr runat="server" id="trPayeeExecutive" visible="false">
        <td class="GridRows">Executive Name:</td>
        <td class="GridRows"><asp:DropDownList ID="ddlExecutive" runat="server" CssClass="controls"  Width="40%" BackColor="White" AutoPostBack="True"  onselectedindexchanged="ddlExecutive_SelectedIndexChanged"></asp:DropDownList></td>
       </tr>
       <tr  runat="server" id="trPayeeOthers" visible="false">
        <td class="GridRows">Payee Name:</td>
        <td class="GridRows"><asp:TextBox runat="server" ID="txtPayeeOthers" CssClass="controls" Width="40%" ValidationGroup="save" MaxLength="80" BackColor="White" ></asp:TextBox></td>
        </tr>
       <tr>
        ...
        <td class="GridRows">
         <asp:DropDownList runat="server" ID="ddlRequestType" CssClass="controls" 
                ...
                onselectedindexchanged="ddlRequestType_SelectedIndexChanged"></asp:DropDownList>
        </td>
       </tr>
...
<tr>
                                        ...
                                        <td class="GridRows" valign="middle">
                                         ...
                                         &nbsp;<asp:ImageButton ID="btnAddEndorser2" runat="server" CssClass="controls" 
                                          ImageUrl="~/Support/btnAddEndorser.png" onclick="btnAddEndorser2_Click" 
                                          ToolTip="Add Endorser" ImageAlign="AbsMiddle" />
                                        </td>
                                   </tr>
    ...
    <%-- <asp:ImageButton runat="server" ID="btnSend" ImageUrl="~/Support/btnSave.jpg" 
       OnClick="btnSend_Click" ValidationGroup="savegroup" />--%>
         <asp:Button ID="btnSend" runat="server" Text="Save As Draft" 
             onclick="btnSend_Click" ValidationGroup="savegroup"/>
     &nbsp;
        <asp:Button ID="btnPrint" runat="server" Text="Submit" 
             onclick="btnPrint_Click" ValidationGroup="savegroup" />
     <%--<asp:ImageButton runat="server" ID="btnPrint" 
       ImageUrl="~/Support/btnSubmitPrint.jpg" ValidationGroup="savegroup" 
  ...
  <tr>
   <td>    
       ...
       <tr  runat="server" id="trRc" visible="false">
        ...
        <td class="GridRows">
         <asp:DropDownList runat="server" ID="ddlRcCode" CssClass="controls" 
          BackColor="white" onselectedindexchanged="ddlRcCode_SelectedIndexChanged"></asp:DropDownList>
        </td>
       </tr>
    ...
    <%-- <asp:ImageButton runat="server" ID="btnSaveAdd" ImageUrl="~/Support/btnAddItem.jpg" OnClick="btnSaveAdd_Click" ValidationGroup="additem" />--%>
     ...
     <%--<asp:ImageButton runat="server" ID="btnSaveAddOther" ImageUrl="~/Support/btnAddItem.jpg" OnClick="btnSaveAddOther_Click" ValidationGroup="addother" Visible="False" />--%></div>
    </div>      
   </td>
  </tr> 
 </table>
