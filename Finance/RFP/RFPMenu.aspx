<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="RFPMenu.aspx.cs" Inherits="Finance_RFP_RFPMenu" Title="The Official STI Head Office Website" %>
     ...
     <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;" id ="divFinance">    
      ...
      <div class="GridBorder">
       <table width="100%" cellpadding="5" cellspacing="1">
        ...
        <% LoadMenuRFPFinance(); %>
        <tr><td colspan="3" class="BrowseAll"><a href="RFPMenuAll.aspx" style="font-size:small;">[Browse All Records]</a></td></tr>
       </table>
      </div>         
     </div><br />
     <%
    ...
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;" id="divUser">    
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="5" cellspacing="1">
       ...
       <% LoadMenuRFP(); %>
       <tr><td colspan="3" class="BrowseAll"><a href="RFPMenuAll.aspx?page=1" style="font-size:small;">[Browse All Records]</a></td></tr>
      </table>
     </div>         
    </div>
   </td>
