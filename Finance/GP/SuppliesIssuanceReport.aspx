<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/TwoPanel.master" CodeFile="SuppliesIssuanceReport.aspx.cs" Inherits="Finance_GP_SuppliesIssuanceReport" %>
...
<asp:Content ID="cntDefault" ContentPlaceHolderID="cphBody" Runat="Server" Visible="true">
 <table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     <b><span class="HeaderText">Supplies Issuance Report (Total per Division)</span></b>
     <br />
     <br />
     
     <br />
     <div style="text-align:center;">
      <web:chartcontrol id="chaBudCon" runat="server" borderstyle="Outset" borderwidth="1px" height="600px" width="900px" ChartFormat="Jpg" LeftChartPadding="20" YValuesInterval="10000" YCustomEnd="140000" YCustomStart="0" BottomChartPadding="9" Padding="9" GridLines="Both" Border-Color="cornflowerblue">
        ...
        <td colspan="14" align="center" class="GridText">
         <table>
          <tr>
           ...
           <td>&nbsp;<b>Supplies Issuance Report Details</b></td>
          </tr>
         </table>           
        </td>
       </tr>
