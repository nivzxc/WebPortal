                ...
                <div class="border" style="padding-top: 10px; padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
                    ...
                    <div class="GridBorder">
                        <table width="100%" cellpadding="3" cellspacing="1">
                           <%-- <tr><td colspan="2" class="GridColumns">&nbsp;<b>Event Details</b></td></tr>--%>
                            <tr>
                                ...
                                <td class="GridRows" style="width: 85%">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="reqEventName" 
                                        ControlToValidate="txtEventName" ErrorMessage="<br>[Event name is required]" 
                                        Display="Dynamic" ValidationGroup="InsertEvent" ForeColor="Red" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="GridRows">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="reqMaxPoints" 
                                        ...
                                        ErrorMessage="<br>[Maximum points is required]" Display="Dynamic" 
                                        ValidationGroup="InsertEvent" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="GridRows">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="reqOrder" 
                                        ControlToValidate="txtOrder" ErrorMessage="<br>[Display order is required]" 
                                        Display="Dynamic" ValidationGroup="InsertEvent" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="GridRows">&nbsp;</td>
                                <td class="GridRows">
                                    <asp:CheckBox ID="chkActive" runat="server" Text="Set As Active Event" />
                                </td>
                            </tr>
                        </table>
                    </div>
