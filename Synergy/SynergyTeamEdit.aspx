<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="SynergyTeamEdit.aspx.cs" Inherits="Synergy_SynergyTeamEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
	<table width="100%" cellpadding="0" cellspacing="0">
		<%--<tr>
			<td>
				<div class="border" style="padding-top: 10px; padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
					...
					<a href="SynergyTeamNew.aspx" class="SiteMap">Edit Team</a> 
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="border" style="padding-top: 10px; padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
					<b><span class="HeaderText">Edit Team</span></b>
					<br />
			...
			<%--				<tr><td colspan="2" class="GridText">&nbsp;<b>Team Details</b></td>--%>
                            ...
                            <tr>
                             ...
                             <tr>
								<td class="GridRows">Event to Join:</td>
								<td class="GridRows">
									<asp:DropDownList runat="server" ID="ddlEvent" CssClass="controls" BackColor="White"></asp:DropDownList>
								</td>
							</tr>
							<tr>
