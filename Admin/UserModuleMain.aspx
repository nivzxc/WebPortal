<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="UserModuleMain.aspx.cs" Inherits="Admin_UserModuleMain" %>
...
<%--  <tr><td style="height:9px;"></td></tr>--%>
  ...
  <tr><td style="height:9px;"></td></tr>
   ...
   <td>    
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">     
     <b><span class="HeaderText">Modules User Settings</span></b>
     <br />
     <br />
            
     <div class="GridBorder">
                          <table width="50%" cellpadding="3" class="grid">
                           <%--<tr>
                           ...
                           <tr>
                            ...
                            <tr>
                             <td class="GridColumns" style="width:80%;"><b>Name</b></td>
                             <td class="GridColumns" style="width:20%;"><b>Delete</b></td>
                            </tr>
