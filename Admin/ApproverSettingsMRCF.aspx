<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="ApproverSettingsMRCF.aspx.cs" Inherits="Admin_ApproverSettingsMRCF" %>

<asp:Content ID="cntApproverSettingsMRCF" ContentPlaceHolderID="cphBody" Runat="Server" Visible="true">
 <table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="ApproverSettingsMRCF.aspx" class="SiteMap">MRCF Approver Settings</a> 
    </div>        
   </td>
  </tr>
  ...
  <tr>
   <td>    
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">     
     <b><span class="HeaderText">MRCF Approver Settings</span></b>
     <br />
     <br />
