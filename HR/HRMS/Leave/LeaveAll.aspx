<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaveAll.aspx.cs" MasterPageFile="~/App_Master/Default.master" Inherits="HR_HRMS_Leave_LeaveAll" %>
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="LeaveAll.aspx?page=1" class="SiteMap">All Leave</a>
    </div>        
   </td>
  </tr>
     --%>
<%--  <tr><td style="height:9px;"></td></tr>--%>
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     <b><span class="HeaderText">All Leave Applications</span></b>
     <br />
     <br />
     <div class="GridBorder" style="width:60%;"> 	          
      <table width="100%" cellpadding="5">
       ...
       <tr>
        ...
        <td class="GridRows">
         <asp:DropDownList runat="server" ID="ddlLeaveType" CssClass="controls" BackColor="white" AutoPostBack="true"></asp:DropDownList>
        </td>
       </tr>       
      </table>
     </div>
        ...
        <td colspan="3" align="center" class="GridText">
         <table>
          <tr>
           ...
           <td>&nbsp;<b>List of Sent Application For Leave</b></td>
          </tr>
         </table>            
        </td>
       </tr>--%>
