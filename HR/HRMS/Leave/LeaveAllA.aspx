<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="LeaveAllA.aspx.cs" Inherits="HR_HRMS_Leave_LeaveAllA" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="LeaveAllA.aspx?page=1" class="SiteMap">All Leave</a>
    </div>        
   </td>
  </tr>--%>
...
<%--  <tr><td style="height:9px;"></td></tr>--%>
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     <b><span class="HeaderText">All Application For Leave</span></b>
     <br />
     <br />
