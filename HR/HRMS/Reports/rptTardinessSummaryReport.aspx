<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/TwoPanel.master" AutoEventWireup="true" CodeFile="rptTardinessSummaryReport.aspx.cs" Inherits="HR_HRMS_Reports_rptTardinessSummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    <%--<div class="ChildPagePanel">
		...
		<a href="rptTardinessSummaryReport.aspx" class="SiteMap">Tardiness Summary Report</a>
    </div>--%>
	<div class="ChildPagePanel">
		<h2>Tardiness Summary Report</h2>
