    ...
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">    
     ...
     <div class="GridBorder" style="width:500px; float: left;"> 	          
      <table width="100%" cellpadding="5">
       <tr>
        ...
        <td class="GridRows" rowspan="2" style="width: 142px">
     ...
     <div class="GridBorder" style="width:1500px;">
      <table width="100%" cellpadding="5" cellspacing="1">
       <tr><td colspan="13" class="GridColumns" style="text-align:center;"><b>Attendance Report - Leave Applications</b></td></tr>
       <tr>
     ...
     <br />
     <div style="width:100%; text-align:center;"><%--<asp:ImageButton runat="server" ID="btnBack" ImageUrl="~/Support/btnBack.jpg" onclick="btnBack_Click" />--%><asp:Button ID="btnBack"
                 runat="server" Text="Back" onclick="btnBack_Click" /></div>                             
    </div>         
   </td>
  </tr>
