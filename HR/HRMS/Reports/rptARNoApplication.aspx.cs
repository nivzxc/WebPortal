...
public partial class HR_HRMS_Reports_rptARNoApplication : System.Web.UI.Page
{
 ...
 protected void LoadRecords()
 {
  ...
  DataTable tblDTRSummary = clsTimesheet.DSGARNoApplication(clsDateTime.GetDateOnly(dtpStart.Date), clsDateTime.GetDateOnly(dtpEnd.Date.AddDays(1)).AddSeconds(-1));
