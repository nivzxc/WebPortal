    ...
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">    
      ...
      <table width="100%" cellpadding="5">
       <tr>
        ...
        <td class="GridRows" rowspan="2"><%--<asp:ImageButton runat="server" ID="btnSearch" 
          ImageUrl="~/Support/btnSearch.jpg"/>--%><asp:Button ID="btnSearch" runat="server" 
     ...
     <div class="GridBorder" style="width:800px;">
      <table width="100%" cellpadding="5" cellspacing="1">
       <tr><td colspan="5" class="GridColumns" style="text-align:center;"><b>Attendance Report - No Application</b></td></tr>
       <tr>
        ...
        <td class="GridColumns" style="width:35%;font-size:x-small;text-align:center;" rowspan="2"><b>Division</b></td>
        <td class="GridColumns" style="font-size:x-small;text-align:center;" colspan="2"><b>Absent</b></td>
       </tr>
       <tr>
        <td class="GridColumns" style="width:13%;font-size:x-small;text-align:center;"><b>Count</b></td>
        <td class="GridColumns" style="width:13%;font-size:x-small;text-align:center;"><b>Days</b></td>                                              
       </tr>
       <% LoadRecords(); %>
      </table>
     </div>      
