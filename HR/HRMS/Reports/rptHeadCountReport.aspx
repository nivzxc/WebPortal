    ...
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">    
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="5" cellspacing="1">
       <tr><td colspan="10" class="GridColumns" style="text-align:center;"><b>Head Count Report</b></td></tr>
       <tr>
        <td class="GridColumns" style="width:10%; font-size:x-small; text-align:center;" rowspan="2"><b>Job Grade</b></td>
        <td class="GridColumns" style="font-size:x-small;text-align:center;" colspan="3"><b>All Employees</b> (Head Office + Billable)</td>
        <td class="GridColumns" style="font-size:x-small;text-align:center;" colspan="3"><b>Head Office</b></td>
        <td class="GridColumns" style="font-size:x-small;text-align:center;" colspan="3"><b>Billable</b></td>
       </tr>
       <tr>
        <td class="GridColumns" style="width:10%;font-size:x-small;text-align:center;"><b>Plantilla Position</b></td>
        <td class="GridColumns" style="width:10%;font-size:x-small;text-align:center;"><b>Actual Filled</b></td>
        <td class="GridColumns" style="width:10%;font-size:x-small;text-align:center;"><b>Actual Unfilled</b></td>
        <td class="GridColumns" style="width:10%;font-size:x-small;text-align:center;"><b>Plantilla Position</b></td>
        <td class="GridColumns" style="width:10%;font-size:x-small;text-align:center;"><b>Actual Filled</b></td>
        <td class="GridColumns" style="width:10%;font-size:x-small;text-align:center;"><b>Actual Unfilled</b></td>
        <td class="GridColumns" style="width:10%;font-size:x-small;text-align:center;"><b>Plantilla Position</b></td>
