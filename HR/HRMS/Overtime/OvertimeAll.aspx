<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="OvertimeAll.aspx.cs" Inherits="HR_HRMS_Overtime_OvertimeAll" %>
 ...
 <%-- <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="OvertimeAll.aspx?page=1" class="SiteMap">All Overtime</a>
    </div>        
   </td>
  </tr>--%>
     <%--
        ...
        <td colspan="3" align="center" class="GridText">
         <table>
          <tr>
           ...
           <td>&nbsp;<b>List of Sent Application For Overtime</b></td>
          </tr>
         </table>            
        </td>
       </tr>--%>
