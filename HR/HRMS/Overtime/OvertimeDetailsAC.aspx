<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="OvertimeDetailsAC.aspx.cs" Inherits="HR_HRMS_Overtime_OvertimeDetailsAC" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href='OvertimeDetailsAC.aspx?otcode=<%Response.Write(Request.QueryString["otcode"]); %>' class="SiteMap">Overtime Details</a>
    </div>        
   </td>
  </tr>--%>
     ...
     <div class="GridBorder">
      ...
      <%-- <tr>
       ...
       <tr runat="server" id="trRRemarks" visible="false">
        ...
        <td class="GridRows"><asp:TextBox runat="server" ID="txtRRemarks" CssClass="controls" Width="99%" ReadOnly="true" TextMode="MultiLine" Rows="3"></asp:TextBox></td>
       </tr>
       <tr>
