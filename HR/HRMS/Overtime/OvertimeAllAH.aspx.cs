...
public partial class HR_HRMS_Overtime_OvertimeAllAH : System.Web.UI.Page
{

 protected void LoadRecords()
 {
  string strWrite = "";
  DataTable tblOvertime = clsOvertime.DSGOvertimeAll(OvertimeUsers.ApproverHead, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlStatus.SelectedValue);
 ...
 {
  Response.Write(clsOvertime.GetPaging(OvertimeUsers.ApproverHead, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlStatus.SelectedValue, "OvertimeAllAH"));
 }
