...
public partial class HR_HRMS_Overtime_OvertimeAllAC : System.Web.UI.Page
{

 protected void LoadRecords()
 {
  string strWrite = "";
  DataTable tblOvertime = clsOvertime.DSGOvertimeAll(OvertimeUsers.ApproverCOO, clsValidator.CheckInteger(Request.QueryString["page"]), Request.Cookies["Speedo"]["UserName"], ddlStatus.SelectedValue);
 ...
 {
  Response.Write(clsOvertime.GetPaging(OvertimeUsers.ApproverCOO, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlStatus.SelectedValue, "OvertimeAllAC"));
 }
