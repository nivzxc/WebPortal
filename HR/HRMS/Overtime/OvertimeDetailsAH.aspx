<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="OvertimeDetailsAH.aspx.cs" Inherits="HR_HRMS_Overtime_OvertimeDetailsAH" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href='OvertimeDetailsAH.aspx?otcode=<%Response.Write(Request.QueryString["otcode"]); %>' class="SiteMap">Overtime Details</a>
    </div>        
   </td>
  </tr>--%>
