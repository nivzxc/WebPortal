...
public partial class HR_HRMS_Overtime_OvertimeDetailsAC : System.Web.UI.Page
{
 ...
 protected void Page_Load(object sender, EventArgs e)
 {
  ...
  if (!Page.IsPostBack)
  {
   clsOvertime.AuthenticateAccessForm(OvertimeUsers.ApproverCOO, Request.Cookies["Speedo"]["UserName"], Request.QueryString["otcode"].ToString());
   clsOvertime ot = new clsOvertime();
   ...
   if (ot.ApproverCOOStatus == "F")
   {
    txtCRemarks.ReadOnly = false;
    txtCRemarks.BackColor = System.Drawing.Color.White;
