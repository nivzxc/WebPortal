<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="UndertimeAllA.aspx.cs" Inherits="HR_HRMS_Undertime_UndertimeAllA" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="UndertimeAllA.aspx?page=1" class="SiteMap">All Undertime</a>
    </div>        
   </td>
  </tr>--%>
        ...
        <td colspan="3" align="center" class="GridText">
         <table>
          <tr>
           ...
           <td>&nbsp;<b>List of Undertime For Your Approval</b></td>
          </tr>
         </table>            
        </td>
       </tr>--%>
