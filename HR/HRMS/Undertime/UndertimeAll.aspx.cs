...
public partial class HR_HRMS_Undertime_UndertimeAll : System.Web.UI.Page
{
 protected void LoadRecords()
 {
  string strWrite = "";
  DataTable tblUndertime = clsUndertime.GetPageRecords(UndertimeUsers.Requestor, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlRequestStatus.SelectedValue);
 ...
 {
  Response.Write(clsUndertime.GetPaging(UndertimeUsers.Requestor, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlRequestStatus.SelectedValue, "UndertimeAll"));
 }
