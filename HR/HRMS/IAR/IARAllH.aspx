<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="IARAllH.aspx.cs" Inherits="HR_HRMS_IAR_IARAllH" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="IARDetailsH.aspx?page=1" class="SiteMap">All Request</a>
    </div>        
   </td>
  </tr>--%>    
