...
public partial class HR_HRMS_IAR_IARAllD : System.Web.UI.Page
{

   protected void LoadRecords()
   {
      string strWrite = "";
      DataTable tblIAR = clsIAR.GetPageRecords(IARUsers.ApproverDivision, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlStatus.SelectedValue);
   ...
   {
      Response.Write(clsIAR.GetPaging(IARUsers.ApproverDivision, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlStatus.SelectedValue, "IARAllH"));
   }
