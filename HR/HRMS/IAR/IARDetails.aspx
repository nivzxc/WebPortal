<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="IARDetails.aspx.cs" Inherits="HR_HRMS_IAR_IARDetails" %>
 ...
 <%-- <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href='IARDetails.aspx?iarcode=<%Response.Write(Request.QueryString["iarcode"]); %>' class="SiteMap">Details</a>
    </div>        
   </td>
  </tr>  --%>
...
<%--       <tr><td colspan="2" class="GridText">&nbsp;<b>Request Details</b></td></tr>--%>
       <tr>
        <td class="GridRows" style="width:20%">IAR Code:</td>
        <td class="GridRows" style="width:80%">
         <asp:TextBox runat="server" ID="txtIARCode" CssClass="controls" Width="80px" ReadOnly="true"></asp:TextBox>
         &nbsp;&nbsp;&nbsp;
         Date Filed:&nbsp;
