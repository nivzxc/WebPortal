<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="IARDetailsH.aspx.cs" Inherits="HR_HRMS_IAR_IARDetailsH" %>
  ...
  <%--<tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href='IARDetailsH.aspx?iarcode=<%Response.Write(Request.QueryString["iarcode"]); %>' class="SiteMap">Details</a>
    </div>        
   </td>
  </tr>  --%>
