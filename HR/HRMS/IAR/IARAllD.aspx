<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="IARAllD.aspx.cs" Inherits="HR_HRMS_IAR_IARAllD" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="IARAllD.aspx?page=1" class="SiteMap">All Request</a>
    </div>        
   </td>
  </tr>  --%>   
      ...
      <table width="100%" cellpadding="5" cellspacing="1">
       <tr>
        <td colspan="3" align="center" class="GridText">
         <table>
          <tr>
           <td>&nbsp;<b>List of Processed Internet Access Request</b></td>
          </tr>
         </table>            
        </td>
       </tr>
       <tr>
        ...
        <td class="GridColumns" style="width:60%;"><b>Details</b></td>
