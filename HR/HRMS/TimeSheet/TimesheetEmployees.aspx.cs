...
public partial class HR_HRMS_TimeSheet_TimesheetEmployees : System.Web.UI.Page
{
 ...
 protected void LoadTimeSheet()
 {
  string strWrite = "";
  string strCSSRow = "";
  DataTable tblTimeSheet = clsTimesheet.GetDataTableProcessed(dtpStart.Date, dtpEnd.Date, ddlEmployee.SelectedValue);
 ...
 protected void Page_Load(object sender, EventArgs e)
 {
  if (!Page.IsPostBack)
  {
   ...
   ddlEmployee.DataSource = clsTimesheetAccess.DSLEmployee(Request.Cookies["Speedo"]["UserName"]);
