<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/TwoPanel.master" CodeFile="TimesheetEmployees.aspx.cs" Inherits="HR_HRMS_TimeSheet_TimesheetEmployees" %>
 ...
 <%-- <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="TimesheetEmployees.aspx" class="SiteMap">Timesheet Employees</a>
    </div>        
   </td>
  </tr>--%>
     ...
     <div class="GridBorder" style="width:500px;"> 	          
      <table width="100%" cellpadding="5">
       <tr>
        ...
        <td class="GridRows" colspan="3"><asp:DropDownList runat="server" ID="ddlEmployee" CssClass="controls"></asp:DropDownList></td>
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="5" cellspacing="1">
       <tr>
        ...
        <td class="GridText" style="width:13%;font-size:x-small;text-align:center;"><b>Date</b></td>
        <td class="GridText" style="width:9%;font-size:x-small;text-align:center;"><b>Time In</b></td>
        <td class="GridText" style="width:9%;font-size:x-small;text-align:center;"><b>Time Out</b></td>
