<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="OBDetailsAR.aspx.cs" Inherits="HR_HRMS_OB_OBDetailsAR" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href='OBDetailsAR.aspx?obcode=<%Response.Write(Request.QueryString["obcode"]); %>' class="SiteMap">OB Details</a>
    </div>        
   </td>
  </tr>--%>
