<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="OBAllA.aspx.cs" Inherits="HR_HRMS_OB_OBAllA" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="OBAllA.aspx?page=1" class="SiteMap">All OB</a>
    </div>        
   </td>
  </tr>--%>
     ...
     <div class="GridBorder" style="width:60%;"> 	          
      <table width="100%" cellpadding="5">
       ...
       <tr>
        ...
        <td class="GridRows">
         <asp:DropDownList runat="server" ID="ddlStatus" CssClass="controls" BackColor="white" AutoPostBack="true" onselectedindexchanged="ddlStatus_SelectedIndexChanged">
        ...
        <td colspan="3" align="center" class="GridText">
         <table>
          <tr>
           ...
           <td>&nbsp;<b>List of Processed OB Applications</b></td>
          </tr>
         </table>            
        </td>
       </tr>--%>
