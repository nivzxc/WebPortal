...
public partial class HR_HRMS_OB_OBAllA : System.Web.UI.Page
{

 protected void LoadRecords()
 {
  string strWrite = "";
  DataTable tblOB = clsOB.GetPageRecords(OBUsers.ApproverHead, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlStatus.SelectedValue);
 ...
 {
  Response.Write(clsOB.GetPaging(OBUsers.ApproverHead, int.Parse(Request.QueryString["page"].ToString()), Request.Cookies["Speedo"]["UserName"], ddlStatus.SelectedValue, "OBAllA"));
 }
