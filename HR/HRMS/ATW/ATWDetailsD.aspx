<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="ATWDetailsD.aspx.cs" Inherits="HR_HRMS_ATW_ATWDetailsD" %>
...
<%--  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href='ATWDetailsD.aspx?atwcode=<%Response.Write(Request.QueryString["atwcode"]); %>' class="SiteMap">ATW Details</a>
    </div>        
   </td>
  </tr>  --%>
...
<%--       <tr><td colspan="2" class="GridText">&nbsp;<b>ATW Details</b></td></tr>--%>
       ...
       <tr>
        ...
        <td class="GridRows"><asp:TextBox runat="server" ID="txtRemarksH" CssClass="controls" Width="85%" ReadOnly="true" TextMode="MultiLine" Rows="3"></asp:TextBox></td>
       </tr>
       <tr>
       ...
       <tr>
        <td class="GridRows" style="vertical-align:top;">Remarks:</td>
        <td class="GridRows"><asp:TextBox runat="server" ID="txtRemarksD" CssClass="controls" Width="85%" ReadOnly="true" TextMode="MultiLine" Rows="3" BackColor="White" MaxLength="500"></asp:TextBox></td>
       </tr>      
      </table>
     </div>     
     <br />     
     <div class="GridBorder">
      <table width="100%" cellpadding="0">
       <tr><td class="">&nbsp;<b>ATW Schedule Details</b></td></tr>       
       <tr>
        <td class="GridRows">
         <div class="GridBorder">
