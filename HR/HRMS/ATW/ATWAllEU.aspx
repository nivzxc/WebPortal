<%@ Page Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="ATWAllEU.aspx.cs" Inherits="HR_HRMS_ATW_ATWAllEU" %>
...
<%--  <tr><td style="height:9px;"></td></tr>   --%>
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     <b><span class="HeaderText">Authority to Work Request</span></b>
     <br />
     <br />
     ...
     <div class="GridBorder"> 	          
      <table width="100%" cellpadding="5" cellspacing="1">
       <tr>
        <td colspan="6" align="center" class="">&nbsp;<b>Authority to Work Request</b>
