...
public partial class HR_HRMS_Reports_rptTardinessSummaryReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		reportString += "<div class='GridBorder'>" +
						"<table width='100%' cellpadding='5'>" +
							"<tr><td colspan='" + columnCount.ToString() + "' class='GridText' style='text-align:center;'><b>Tardiness Summary</b></td></tr>" +
							"<tr>" +
		...
		foreach (DataRow rowD in divisionTable.Rows)
		{
			...
			foreach (DataRow rowE in divisionEmployee.Rows)
			{
				...
				foreach (DataRow rowM in monthsTable.Rows)
				{
					...
					employeeTotalCount = employeeTotalCount + employeeCount;
					employeeTotalSum = employeeTotalSum + employeeSum;
