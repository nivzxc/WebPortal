    ...
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">    
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="5" cellspacing="1">
       <tr><td colspan="9" class="GridText" style="text-align:center;"><b>Attendance Report - Leave For Approval</b></td></tr>
       <tr>
        ...
        <td class="GridText" style="width:15%;font-size:x-small;text-align:center;"><b>Leave Type</b></td>
        ...
        <td class="GridText" style="width:5%;font-size:x-small;text-align:center;"><b>Unit</b></td>
