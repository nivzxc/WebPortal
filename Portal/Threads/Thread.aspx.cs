...
public partial class Threads_Thread : System.Web.UI.Page
{
	...
	private void LoadThreadDetails(int threadID)
	{
		...
		if (thread != null)
		{
			...
			{
				lnkForumList.Text = threadCategoryName;
				lnkForumList.NavigateUrl = "~/Threads/ThreadList.aspx?categoryid=" + thread.ThreadCategoryID.ToString();
				lnkForumThread.Text = thread.Title;
				lnkForumThread.NavigateUrl = "~/Threads/Thread.aspx?threadid=" + threadID.ToString() + "&page=1";
				...
				if (thread.AttachedFileName.Length > 0)
				{
                                                ...
                                                "<table cellpadding='0' cellspacing='0' width='100%'>" +
                                                    "<tr>" +
                                                        ...
                                                        "<td align='right' valign='top'>" +
                                                            (dr["Username"].ToString() == username ? "<a href='ReplyEdit.aspx?threadid=" + dr["ThreadID"].ToString() + "&threadreplyid=" + dr["ThreadReplyID"].ToString() + "' style='font-size:small;'>[Edit Reply]</a>" : "") +
