...
public partial class Threads_ThreadNew : System.Web.UI.Page
{
	...
	private void InsertRecord()
	{
		...
		try
		{
			...
			if (fuAttachment.HasFile)
			{
				...
				thread.AttachedFileDescription = (txtDescription.Text.Length == 0 ? "Attached File" : txtDescription.Text);
			}
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		lnkThreadList.NavigateUrl = "~/Threads/ThreadList.aspx?categoryid=" + threadCategoryID.ToString();
		lnkThreadList.Text = DALThread.GetCategoryName(threadCategoryID);
		lnkThreadNew.NavigateUrl = "~/Threads/ThreadNew.aspx?categoryid=" + threadCategoryID.ToString();
