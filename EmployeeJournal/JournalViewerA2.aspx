<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="JournalViewerA2.aspx.cs" Inherits="EmployeeJournal_JournalViewerA" %>
...
<HeaderStyle Font-Bold="True" Height="0px"></HeaderStyle>
    ...
    <br />
        ...
        <br />
              &nbsp;
          <asp:Button ID="btnApprove" runat="server" Text="Read and Commented"  
            Visible="True" onclick="btnApprove_Click"/>
      &nbsp;
