<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="JournalApprovers.aspx.cs" Inherits="EmployeeJournal_JournalApprovers" %>
...
<%--  <tr><td style="height:9px;"></td></tr>--%>
   ...
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     <b><span class="HeaderText">Add Reviewer</span></b>
     <br />
     <br />
      ...
      <table width="100%" cellpadding="3" class="grid"> 
       ...
       <tr>
        ...
        <td class="GridRows" style="height: 20px; width:70%;">
            <asp:DropDownList ID="ddlReviewer" runat="server" CssClass="controls" 
                AutoPostBack="True" 
       ...
       <tr  id="trDivision" runat="server">
        ...
        <td class="GridRows">
            <asp:DropDownList ID="ddlEmployee" runat="server" CssClass="controls" 
                AutoPostBack="True">
            </asp:DropDownList>
           </td>
       </tr>
     ...
     <%--<asp:ImageButton runat="server" ID="btnSearch" ImageUrl="~/Support/btnSearch.jpg" 
      ...
      <%--<asp:ImageButton runat="server" ID="btnSave" ImageUrl="~/Support/btnSave.jpg" 
         ...
         <asp:Button ID="btnSave" runat="server" Text="Add Employee" 
  ...
  <tr><td style="height:9px;"></td></tr>
   ...
   <td>    
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">     
     Employee(s) under Mr/Ms <b><asp:Label ID="lblReviewer" runat="server" Text="[]"></asp:Label></b>
     <br />
     <br />
                          ...
                          <table width="100%" cellpadding="3" class="grid">
                           ...
                           <tr>
                            ...
                            <tr>
                             ...
                             <td class="GridColumns" style="width:50%;"><b>Department</b></td>
                            </tr>
