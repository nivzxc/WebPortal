<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Default.master" AutoEventWireup="true" CodeFile="EmployeeJournalListS.aspx.cs" Inherits="EmployeeJournal_EmployeeJournalListS" %>
...
&nbsp;<div class="GridBorder" style="width:500px;"> 	          
      <table width="100%" cellpadding="5">
       <tr>
        <td class="GridRows">Journal Year:</td>
       ...
       <tr>
        <td class="GridRows">Journal Dates:</td>
        <td class="GridRows" colspan="3">
