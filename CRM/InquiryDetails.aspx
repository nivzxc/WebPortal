<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Default.master" CodeFile="InquiryDetails.aspx.cs" Inherits="CRM_InquiryDetails" %>
  ...
  <tr>
   <td>
    <div class="border" style="padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:10px;">
     ...
     <a href="InquiryDetails.aspx" class="SiteMap">Inquiry Details</a>
    </div>        
   </td>
  </tr>
     ...
     <div class="GridBorder">
      <table width="100%" cellpadding="3">
       ...
       <tr>
        ...
        <td class="GridRows"><asp:TextBox runat="server" ID="txtResponse" ReadOnly="true" CssClass="controls" Width="98%" Rows="12" TextMode="MultiLine"></asp:TextBox></td>
       </tr>       
       <tr>
